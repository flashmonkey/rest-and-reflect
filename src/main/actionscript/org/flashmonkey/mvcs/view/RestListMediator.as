package org.flashmonkey.mvcs.view
{
	...
	public class RestListMediator extends Mediator
	{
		[Inject] public var view:IRestList;
		...
		public function RestListMediator()
		{
			super();
		}
		...
		protected function invalidateDataProvider(value:IList):void 
		{
